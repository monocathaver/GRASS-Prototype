            ...
            <div class="menu">
                ...
                <div class="forms">
                    <div class="forms-header" @click="toggleForms"
                        :class="{ 'active': $route.path.startsWith('/student/studentRequestCummulative') || $route.path.startsWith('/student/studentRequestClient') }">
                    ...
                    <div v-show="showForms">
                        <ul class="menu-option" :class="{ 'centered': !showSidebar }">
                            <li>
                                <RouterLink to="studentRequestCummulative" class="form-sidebar-menu"
                            ...
                            <li>
                                <RouterLink to="studentRequestClient" class="form-sidebar-menu"

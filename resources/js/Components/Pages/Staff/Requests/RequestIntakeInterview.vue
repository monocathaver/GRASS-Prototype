        ...
        <div class="column-1">
            <div class="table-card">
                <div class="sub-header">
                    <div class="content-text">Intake Interview Form Requests</div>
                </div>
...
const initializeDataTable = () => {
    $('#table-iif-requests').DataTable();
};

const getRequests = async () => {
    try{
        const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/v1/iif-requests`);

        ...
        <div class="content">
            <div class="table-card">
                <div class="sub-header">
                    <div class="content-text">Assignment Cumulative Record Form</div>
                </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    <button style="padding-right: 10px;" class="card14" type="button"
                                        id="sendUserCertDropdown" @click="goToFill">
                                        <span class="send-text">Fill</span>
                                    </button>
                                </div>
                            </td>
                        </tr>
...
const goToFill = () => {
    router.push({ name: 'student-fillCumulativeRecord'})
}
</script>
